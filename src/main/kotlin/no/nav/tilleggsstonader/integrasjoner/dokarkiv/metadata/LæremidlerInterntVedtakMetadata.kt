...
@Component
object LæremidlerInterntVedtakMetadata : Dokumentmetadata {
    ...
    override val dokumenttype: Dokumenttype = Dokumenttype.LÆREMIDLER_INTERNT_VEDTAK
    override val tittel: String? = "Internt vedtak læremidler"
